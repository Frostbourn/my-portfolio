        ...
        <div className="card py-3 col-12 col-md-6 col-lg-4">
            <div className="card-wrapper">
                ...
                <div className="card-box">
                    ...
                    <p className="mbr-text mbr-fonts-style align-center display-7">Planer postów</p>

                </div>
                <div className="mbr-section-btn align-center"><a href="https://postplaner.pl" className="btn btn-success display-4" target="_blank">ODWIEDŹ STRONĘ</a></div>
            </div>
        </div>
        <div className="card py-3 col-12 col-md-6 col-lg-4">
            <div className="card-wrapper">
                ...
                <div className="card-box">
                    ...
                    <p className="mbr-text mbr-fonts-style align-center display-7">Strona firmy transportowej</p>

                </div>
                <div className="mbr-section-btn align-center"><a href="https://mltrans.eu" className="btn btn-success display-4" target="_blank">ODWIEDŹ STRONĘ</a></div>
            </div>
        </div>
        <div className="card py-3 col-12 col-md-6 col-lg-4">
            <div className="card-wrapper">
                ...
                <div className="card-box">
                    ...
                    <p className="mbr-text mbr-fonts-style align-center display-7">Sklep z obuwiem</p>

                </div>
                <div className="mbr-section-btn align-center"><a href="https://lakini.pl" className="btn btn-success display-4" target="_blank">ODWIEDŹ STRONĘ</a></div>
            </div>
        </div>
